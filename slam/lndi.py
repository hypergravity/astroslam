...
class Lndi(object):
    ...
    def predict_label_rand(self, flux_goal, X_init, X_std, n_rand):
        n_loop = 0
        while True:
            n_loop += 1
            print('@Cham: n_loop = %s ...' % n_loop)
            X_rand = self.generate_label_rand(X_init, X_std, n_rand)
            X_rand = np.vstack((X_init, X_rand))
            ...
            i_min, chi2_min, flux_cont_min = best_chi2(self.wave,
                                                       flux_rand, flux_goal)
            ...
            if i_min == 0:
                ...
                X_init = X_rand[i_min]
        return(X_rand[i_min], chi2_min, flux_cont_min,
               flux_rand[i_min]*flux_cont_min)
